...
<html lang="en">
  <head>
    ...
    <title>NEXTGENSCHLOAR</title>
  </head>
  <body>
     <!-- Start Nagigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top" style="background-color: #E78A1D;">
      <a href="./index.php" class="navbar-brand"><img src="./image/logo/applogo.PNG" alt="not found" width="60" height="auto"></a>
      <span class="navbar-text">Learning Management System</span>
