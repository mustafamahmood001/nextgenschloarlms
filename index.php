...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        ...
        <img src="./image/projectimage/download (1).jfif" alt="not found">
        </video>
        <div class="vid-overlay"></div>
      </div>
      <div class="vid-content" >
        <h1 class="my-content">Welcome to NEXTGENSCHLOAR</h1>
        <small class="my-content">Learn and Implement</small><br />
        <?php    
              if(!isset($_SESSION['is_login'])){
                echo '<a class="btn btn-danger mt-3" href="#" data-toggle="modal" data-target="#stuRegModalCenter" style="background-color: #E78A1D; color:#333333">Get Started</a>';
              } else {
    ...
    <div class="container-fluid bg-danger txt-banner" > <!-- Start Text Banner -->
        <div class="row bottom-banner" style='background-color: #E78A1D;'>
          <div class="col-sm">
    ...
    <div class="container mt-5"> <!-- Start Most Popular Course -->
      ...
      <div class="text-center m-2">
        <a class="btn btn-danger btn-sm" href="courses.php"  style="background-color: #E78A1D; color:#333333">View All Course</a> 
      </div>
    ...
    ?>  
     ...
     <!-- Start Students Testimonial -->
      <div class="container-fluid mt-5" style="background-color: #E78A1D; color:#333333" id="Feedback">
        <h1 class="text-center testyheading p-4" style="color:#333333"> Student's Feedback </h1>
        <div class="row">
          <div class="col-md-12">
            <div id="testimonial-slider" class="owl-carousel" style="background-color: #E78A1D; color:#333333">
            <?php 
            ...
            ?>
              <div class="testimonial" style="background-color: #E78A1D; color:#333333">
                <p class="description">
    ...
    <!-- Start About Section -->
    <div class="container-fluid p-4" style="background-color:#E78A1D">
      <div class="container" style="background-color:#E78A1D">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>NEXTGENSCHLOAR provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>NEXTGENSCHLOAR Pvt Ltd <br> Lahore <br> Pakistan <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
